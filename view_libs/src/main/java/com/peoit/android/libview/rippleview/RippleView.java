package com.peoit.android.libview.rippleview;
...
import com.peoit.android.libview.R;
...
public class RippleView extends RelativeLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        if (!this.isInEditMode()) {
            ...
            this.rippleColor = typedArray.getColor(R.styleable.RippleView_rv_color, this.getResources().getColor(R.color.rippelColor));
    ...
    public RippleView.RippleType getRippleType() {
        return RippleView.RippleType.values()[this.rippleType.intValue()];
    }

    public void setRippleType(RippleView.RippleType rippleType) {
