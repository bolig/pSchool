 ...
 * last: ...
 */
public class AutoClearEditText extends EditText implements View.OnFocusChangeListener, TextWatcher {
     ...
     * 图标到控件右边的间距 - 图标的宽�?�?EditText的宽�?- 图标到控件右边的间距之间我们就算点击了图标，竖直方向就没有考虑
     */
    @Override
