...
public class LoadImageTask extends AsyncTask<String, Integer, Drawable> {
    ...
    protected Drawable doInBackground(String... params) {
        ...
        try {
            return Glide.with(mContext).load(source).into(CommonUtil.w_screeen - CommonUtil.dip2px(mContext, 32), 400).get();
    ...
    protected void onPostExecute(Drawable drawable) {
        if (drawable != null && mTextView != null && mDrawable != null) {
            ...
            width = CommonUtil.w_screeen - CommonUtil.dip2px(mContext, 32);
