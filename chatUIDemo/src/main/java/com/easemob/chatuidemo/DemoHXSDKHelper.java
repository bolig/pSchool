...
public class DemoHXSDKHelper extends HXSDKHelper{
    ...
    protected void initListener(){
        ...
        //注册消息事件监听
        initEventListener();
        Log.i("initEventListener", "initEventListener");
    }
    ...
    protected void initEventListener() {
        eventListener = new EMEventListener() {
            ...
            public void onEvent(EMNotifierEvent event) {
                ...
                DemoApplication.getInstance().notifyMainActivity();
                Log.i("onEvent",CommonUtils.getTopActivity(appContext));
//                if (CommonUtils.getTopActivity(appContext).equals("com.peoit.android.online.pschool.ui.activity.HomeActivity.java")) {
//                    DemoApplication.getInstance().notifyMainActivity();
//                }
